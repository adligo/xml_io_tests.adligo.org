...
import org.adligo.xml_io.tests.client.models.ComplexCollections;
import org.adligo.xml_io.tests.client.models.GenericEnum;
import org.adligo.xml_io.tests.client.models.SimpleCollections;
import org.adligo.xml_io.tests.client.models.SimpleCollectionsWithComments;
import org.adligo.xml_io.tests.client.models.SimpleDefaultFailure;
import org.adligo.xml_io.tests.client.models.SimpleEnum;
import org.adligo.xml_io.tests.client.models.SimpleEnumContainer;
import org.adligo.xml_io.tests.client.models.SimpleFailureModel;
import org.adligo.xml_io.tests.client.models.SimplePrivateFailure;
import org.adligo.xml_io.tests.client.models.SimpleSerializable;
import org.adligo.xml_io.tests.client.models.SimpleSqlDateFailureModel;
import org.adligo.xml_io.tests.client.models.SimpleStaticFieldModel;
import org.adligo.xml_io.tests.client.models.SqlDateGeneicFailureModel;
import org.adligo.xml_io.tests.client.models.other_pkg.ComplexMaps;
import org.adligo.xml_io.tests.client.models.other_pkg.SimpleIsSerializable;
import org.adligo.xml_io.tests.client.models.other_pkg.SimpleMaps;
...
public class IsXmlIOSerializableTests extends ATest {
	...
	public void testSimpleSqlDateFailureModel() {
		...
		assertEquals("You can't have a java.sql.Date you need java.util.Date  " +
				...
				"[class org.adligo.xml_io.tests.client.models.SimpleSqlDateFailureModel]",
				ex.getMessage());
	}
	...
	public void testSqlDateGenericFailureModel() {
		...
		assertEquals("You can't have a java.sql.Date you need java.util.Date  " +
				"in class class java.sql.Date with parents " +
				"[interface java.util.Collection, class org.adligo.xml_io.tests.client.models.SqlDateGeneicFailureModel]",
				ex.getMessage());
	}
