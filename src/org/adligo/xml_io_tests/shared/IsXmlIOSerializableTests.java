...
import org.adligo.xml_io_tests.shared.models.ComplexCollections;
import org.adligo.xml_io_tests.shared.models.GenericEnum;
import org.adligo.xml_io_tests.shared.models.SimpleCollections;
import org.adligo.xml_io_tests.shared.models.SimpleCollectionsWithComments;
import org.adligo.xml_io_tests.shared.models.SimpleDefaultFailure;
import org.adligo.xml_io_tests.shared.models.SimpleEnum;
import org.adligo.xml_io_tests.shared.models.SimpleEnumContainer;
import org.adligo.xml_io_tests.shared.models.SimpleFailureModel;
import org.adligo.xml_io_tests.shared.models.SimplePrivateFailure;
import org.adligo.xml_io_tests.shared.models.SimpleSerializable;
import org.adligo.xml_io_tests.shared.models.SimpleSqlDateFailureModel;
import org.adligo.xml_io_tests.shared.models.SimpleStaticFieldModel;
import org.adligo.xml_io_tests.shared.models.SqlDateGeneicFailureModel;
import org.adligo.xml_io_tests.shared.models.other_pkg.ComplexMaps;
import org.adligo.xml_io_tests.shared.models.other_pkg.SimpleIsSerializable;
import org.adligo.xml_io_tests.shared.models.other_pkg.SimpleMaps;
...
public class IsXmlIOSerializableTests extends ATest {
	...
	public void testSimpleSqlDateFailureModel() {
		...
		assertEquals("You can't have a java.sql.Date you need java.util.Date  " +
				...
				"[class org.adligo.xml_io_tests.shared.models.SimpleSqlDateFailureModel]",
				ex.getMessage());
	}
	...
	public void testSqlDateGenericFailureModel() {
		...
		assertEquals("You can't have a java.sql.Date you need java.util.Date  " +
				"in class class java.sql.Date with parents " +
				"[interface java.util.Collection, class org.adligo.xml_io_tests.shared.models.SqlDateGeneicFailureModel]",
				ex.getMessage());
	}
